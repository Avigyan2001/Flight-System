...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.3.1/dist/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
	...
	<div class="row">
		<div class="container">
			<c:choose>  
			    <c:when test="${uriType.equals(\"listFlight\")}">  
			       <h3 class="text-center">Flights Available For Today</h3>  
			    </c:when>  
			    <c:when test="${uriType.equals(\"listFlightCity\")}">  
			       <h3 class="text-center">Flights Available for given choices</h3>
			    </c:when>  
			    <c:otherwise>  
			       <h3 class="text-center">Limited Time Deals Available Currently</h3> 
			    </c:otherwise>  
			</c:choose> 
			<br/>
