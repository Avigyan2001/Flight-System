	...
	<div class="container col-md-5">
		<div class="card">
			<div class="card-body">
				...
				<fieldset class="form-group">
					<label>Enter Cost Range:<br><br>Minimum cost: </label> <input type="text" class="form-control" name="minCost">
				</fieldset>
				<fieldset class="form-group">
					<label>Maximum cost: </label> <input type="text" class="form-control" name="maxCost">
				</fieldset>
